# create a game where you need to guess if something is higher or lower than something else
...
high_score = 0
# choosing celeb 1
celebrity1 = random_celeb()
# game loop
while continue_game:
    # choosing celeb 2
    celebrity2 = random_celeb()
    # checking that celeb 2 isnt celeb 1
    while celebrity1 == celebrity2:
        celebrity2 = random_celeb()
    print("Who has more followers?:")
    print(f"Choice 'a': {celebrity1['name']}: {celebrity1['description']} from {celebrity1['country']}\n"
          f"VS\n"
          f"Choice 'b': {celebrity2['name']}: {celebrity2['description']} from {celebrity2['country']}")
    # asking playing for guess
    choice = input().lower()
    ...
    if celebrity1['follower_count'] > celebrity2['follower_count'] and choice == "a":
        ...
        if score > high_score:
            high_score = score
            print(f"Congrats! You set a new high score of {high_score}!")
        else:
